                ...
                if (PopupNode.ToolTipText == "Method")
                {
                    ...
                    if (acpiLib.GetMethodArgCount((string)PopupNode.Tag, ref args) && args < 8)
                    {
                        ...
                        if (args == 0)
                        {
                            ...
                            {
                                Console.WriteLine((string)PopupNode.Tag);
                                aslText.Text += string.Format("\n\n{0}", strAsl);
                            }
                        }
                        else
                        {
                            ...
                            if (formArgInput.GetEvalState())
                            {
                                ...
                                if (methodargs != null)
                                {
                                    IntPtr pArg = IntPtr.Zero; //pArg 标识的是ACPI_EVAL_INPUT_BUFFER_COMPLEX* 的地址
                                    for (int iIndex = 0; iIndex < methodargs.Count; iIndex++)
                                    {
                                        ...
                                        {//写入参数
                                            case 0:
                                                ...
                                                Console.WriteLine("pargs 1 :"+ methodargs[iIndex].ulValue);
                                                break;
                                            case 1:
                                    ...
                                    {
                                        aslText.Text += string.Format("\n\n{0}", strValue);
                                        Console.WriteLine("GetEvalArgResult  true");
                                    } else
                                    {
                                        aslText.Text += "Bad";
                                    }
